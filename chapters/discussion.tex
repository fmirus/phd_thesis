...
Therefore, we conclude, that the encoding the scene in semantic vectors is able to capture the essential semantics of the spatial information of the driving scene.
