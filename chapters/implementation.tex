...
\end{center}
\todo[inline]{check if newer files from leo are available with traffic sign or traffic rules in them}
\begin{itemize}
...
\begin{figure}[t!]
	...
	\caption{An example scene visualizing the data of an overtaking maneuvre in a highway situation at selected timesteps.} \label{fig:overtaking}
\end{figure}
