...
Representation approaches other than the ones mentioned before are rather rarely used in an automotive context.
Although semantic and structured information will gain increasing importance with the advent of more and more machine learning driven assistant systems, representations that are able to capture and manipulate such information are still hardly used in vehicle context.
