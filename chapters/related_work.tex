...
\end{figure*}
\todo{check and possibly update figure \ref{fig:neuro_time}}
...
\begin{figure*}[t!]
	...
	\caption{examples motion prediction, Image source \cite{Lefevre2014}}
...
Probabilistic models like costmaps \cite{Bahram2016} account for physical constraints on the movements of the other vehicles.
